...
- LDA训练
    ...
    - k=the number of topics 取值范围[*,*]，以步长*递增
...
n_features = 2500
n_top_words = 40
n_topics = range(5, 20, 5)  # 话题数从1到9，根据perplexity决定
...
print(docLst)
print('\n')
with open(textPre_FilePath, 'w') as f1:
    for line in docLst:
        f1.write(str(line))
        f1.write('\n')
#'''
...
print("Best # of index: ", best_index)
...
print_top_words(lda_models[best_index], tf_feature_names, n_top_words)
